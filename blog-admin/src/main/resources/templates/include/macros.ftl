...
<head>
    ...
    <link href="/assets/css/ccm.core.css" rel="stylesheet">
    <#nested>
</head>
<body class="nav-md">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/" class="site_title"><i class="fa fa-coffee"></i> <span style="font-size:16px;">${config.siteName}后台管理系统</span></a>
                </div>
