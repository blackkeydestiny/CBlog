<footer>
    <div class="pull-right">
        Copyright © 2018 <a href=# target="_blank">chuming.chen</a> · Powered by <a href=# title="DBlog是一款简洁美观、自适应的Java博客系统..." target="_blank"><strong>DBlog</strong></a>. All Rights Reserved.
    </div>
...
<script src="/assets/js/ccm.tool.js"></script>
<script src="/assets/js/ccm.upload-preview.js"></script>
<script src="/assets/js/ccm.core.js"></script>
<script src="/assets/js/ccm.table.js"></script>
</body>
</html>