<div class="col-sm-3 blog-sidebar">
                    ...
                    <div class="feed-about">
                        ...
                        <ul class="widget-icon">
                            <li class="weixin auto-shake" data-container="body"
                                data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true" data-content="<img src='${config.staticWebSite}/img/wxgzh_400px.png' style='width: 130px;' alt='QR Code'>">
                            ...
                            <li class="github auto-shake">
                                <a class="tag-icon" href="https://github.com/blackkeydestiny" title="点击查看我的github" target="_blank" rel="external nofollow"><i class="fa fa-github"></i></a>
                            </li>
                        </ul>
                        <!-- 方案二：列表展示 -->
                        <!--<ul class="list-unstyled">
                            <li><i class="fa fa-info-circle fa-fw"></i>博主：<small>陈楚明</small></li>
    ...
    <div class="sidebar-module">
        ...
        <ul class="list-unstyled list-inline">
            <@ccmTag method="tagsList" pageSize="10">
