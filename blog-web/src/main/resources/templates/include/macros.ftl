<#-- 公共顶部 -->
<#macro header title="陈楚明博客" keywords="默认文字" description="默认文字" canonical="">
...
<head>
    ...
    <meta name="baidu-site-verification" content="3OxI92b83y"/>
    <title>${title}</title>
    ...
    <#--黑白界面-->
    <#if config.themeColor?if_exists && config.themeColor?string == "3">
        <style>
            html {
